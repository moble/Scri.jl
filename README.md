...
[![Stable Documentation](https://img.shields.io/badge/docs-stable-blue.svg)](https://moble.github.io/Scri.jl/stable)
[![Development documentation](https://img.shields.io/badge/docs-dev-blue.svg)](https://moble.github.io/Scri.jl/dev)
[![Test workflow status](https://github.com/moble/Scri.jl/actions/workflows/Test.yml/badge.svg?branch=main)](https://github.com/moble/Scri.jl/actions/workflows/Test.yml?query=branch%3Amain)
...
> [!WARNING]
> **Documentation in progress.**  This documentation is still being
> written.  Some sections may be incomplete.  Please bear with me
> while I fill things in.
